...
<div class="ui segment">
    ...
    <a href="{{ url.get() }}tours/country/add" class="ui button positive">
...
<table class="ui table very compact celled">
    ...
    <tbody>
    {% for item in entries %}
        {% set link = url.get() ~ "tours/country/edit/" ~ item.getId() %}
        <tr>
            ...
            {% set prod_link = helper.langUrl(['for':'countries', 'country': item.getSlug()]) %}
